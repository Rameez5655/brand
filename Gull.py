...
$$    $$/ $$    $$/ $$ |$$ |$$    $$/ 
 $$$$$$/   $$$$$$/  $$/ $$/  $$$$$$/  
   ...
   {M}•{K}•{H}• {P}GULLU MULTI BROOTFORCE FACEBOOK  {H}•{K}•{M}•""")
def logo2():
	return str(f"""
...
def clon_email():
	...
	global ok , cp
	print(f' [{hh}>{P}] dump fb email, max 1000 id')
	nama = input(' target : ')
	if ',' in str(nama):
...
def atur_atur():
	...
	print(f"{P} ─────────────────────────────")
	ch = input(f' [{hh}1{P}] MANUAL [{hh}2{P}] COMBINE [{hh}3{P}] AUTO : ')
